...
import uk.ac.ebi.eva.lib.entities.DgvaStudyBrowserOld;
...
@Deprecated
final class DgvaStudyOldTestData {
    ...
    private DgvaStudyOldTestData() {}

    static void persistTestData(TestEntityManager entityManager) {
        DgvaStudyBrowserOld studyOld1 = new DgvaStudyBrowserOld(STUDY_1_ID, 1000, 10, 100, "9606", HUMAN, HOMO_SAPIENS, "1111",
                                                                "alias1", "Study 1", CONTROL_SET, "PRJ1", "www.study1.com",
                                                                "This is study 1", "Sequence alignment", "HMM", "Sequencing",
                                                                "Illumina", "GRCh38");
        DgvaStudyBrowserOld studyOld2 = new DgvaStudyBrowserOld("estd2", 2000, 20, 200, "9606", HUMAN, HOMO_SAPIENS, "2222",
                                                                "alias2", "Study 2", COLLECTION, "PRJ2", "www.study2.com",
                                                                "This is study 2", "Sequence alignment", "HMM", "Sequencing",
                                                                "Illumina", "GRCh38");
        DgvaStudyBrowserOld studyOld3 = new DgvaStudyBrowserOld("estd3", 3000, 30, 300, "9606", MOUSE, M_MUSCULUS, "3333",
                                                                "alias3", "Study 3", CONTROL_SET, "PRJ3", "www.study3.com",
                                                                "This is study 3", "Sequence alignment", "HMM", "Sequencing",
                                                                "Illumina", "MGSCv37");

        entityManager.persist(studyOld1);
        entityManager.persist(studyOld2);
        entityManager.persist(studyOld3);
    }
}