...
@DataJpaTest
@Deprecated
public class StudyDgvaDBAdaptorOldTest {
    ...
    public void getStudyById() throws Exception {
        QueryResult<VariantStudy> queryResult = studyDgvaDBAdaptor.getStudyById(DgvaStudyOldTestData.STUDY_1_ID, new QueryOptions());

        assertEquals(1, queryResult.getNumTotalResults());
        VariantStudy variantStudy = queryResult.first();
        assertEquals(DgvaStudyOldTestData.STUDY_1_ID, variantStudy.getId());
    }
