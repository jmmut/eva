...
public class DgvaDBOldUtils {
    ...
    public static Specification getSpeciesAndTypeFilters(QueryOptions queryOptions) {
        ...
        if (queryOptions.containsKey(QueryOptionsConstants.SPECIES)) {
            ...
            speciesSpecifications = where(in(DgvaStudyBrowserRepositoryOld.COMMON_NAME, species))
                    .or(in(DgvaStudyBrowserRepositoryOld.SCIENTIFIC_NAME, species));
        }
        ...
        if (queryOptions.containsKey(QueryOptionsConstants.TYPE)) {
            ...
            typeSpecifications = where(in(DgvaStudyBrowserRepositoryOld.STUDY_TYPE, (Object[])types));
            for (String type : types) {
                typeSpecifications = typeSpecifications.or(like(DgvaStudyBrowserRepositoryOld.STUDY_TYPE, "%" + type + "%"));
            }
        }
