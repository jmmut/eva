...
@Transactional
@Deprecated
public interface DgvaStudyBrowserRepositoryOld extends
        JpaRepository<DgvaStudyBrowserOld, String>,
        ExtendedJpaRepositoryFunctions<DgvaStudyBrowserOld, String>,
        JpaSpecificationExecutor<DgvaStudyBrowserOld> {
